...
- `application`: Code for reproducing the applications presented in Section 4. The additional plots of the estimated pollen-climate relationships are given [here](application/results/forward_module).
